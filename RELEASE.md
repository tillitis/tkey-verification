...
This version brings a lot of refactoring, aiming at simplfying
building and program structure. Only the biggest changes
will be mentoned here, see [complete
...
- Pointing to tillitis.se/verify if an error occur when verifying a
  TKey, with explainations to common errors
