...
func TestVerifyProof(t *testing.T) {
	...
	digest, err := sumcrypto.HashFromHex("ae5155e5f4c4fdc81f976f5613750b3f5cba011391a55aa20c90b07c58b3cbaf")
	if err != nil {
		t.Fatal(err)
	}
	...
	if err := v.VerifyProofDigest(digest, *policy, sigsumKeys); err != nil {
